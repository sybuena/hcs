    ...
    hidePullHeader: function(animated, top) {
      ...
      return this.each(function() {
        ...
        if (_isInitialized($this)) {
          ...
          //$('.scrollz-container').scrollTop(_getPullHeaderHeight($this));
          if (settings.pull) {
            if (animated) {
                //$('.scrollz-pull-header').addClass('initial');
                //console.log($('.scrollz-pull-header').css());
                //_changePullHeaderState($this, 'initial');
              //  console.log(_getPullHeaderHeight($this));
                $('.scrollz-container').scrollTop(_getPullHeaderHeight($this));
                _changePullHeaderState($this, 'initial');
                /*container.animate({scrollTop: _getPullHeaderHeight($this)}, 100, function() {
                   _changePullHeaderState($this, 'initial');
